...
export default function WholesalerOrders() {
  ...
  const [orders, setOrders] = useState<Order[]>([
    {
      ...
      items: [
        {
          productName: "iPhone 15 Pro Cases (Bulk)",
          quantity: 2,
          price: 10800,
          total: 21600,
        },
        {
          productName: "USB-C Cables (Bulk)",
          quantity: 1,
          price: 20400,
          total: 20400,
        },
    ...
    },
    {
      ...
      items: [
        {
          productName: "Samsung Chargers (Bulk)",
          quantity: 3,
          price: 15000,
          total: 45000,
        },
    ...
    },
    {
      ...
      items: [
        {
          productName: "Samsung Fast Chargers (Bulk)",
          quantity: 5,
          price: 18000,
          total: 90000,
        },
  ...
  const typeCounts = useMemo(() => {
    return {
      all: orders.length,
      purchase_order: orders.filter((o) => o.orderType === "purchase_order")
        .length,
  ...
  const handleOrderAction = () => {
      ...
      orders.map((order) =>
        order.id === selectedOrder.id
          ? {
              ...
              wholesalerResponse: responseMessage || undefined,
            }
          : order,
      ),
    );
    ...
    toast({
      title:
        responseAction === "approved" ? "Order Approved" : "Order Rejected",
  ...
  const openWhatsApp = (number: string, name: string, orderNumber: string) => {
    const message = encodeURIComponent(
      `Hello! This is ${user?.businessName || user?.username} regarding order ${orderNumber}.`,
    );
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between item-center space-y-3">
        <div>
            ...
            <CardFooter className="flex flex-col gap-2">
              <Button
                ...
                onClick={() =>
                  openWhatsApp(
                    order.whatsapp,
                    order.shopName || order.salesPersonName || "",
                    order.orderNumber,
                  )
                }
                className="w-full"
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <Button
              ...
              disabled={
                responseAction === "rejected" && !responseMessage.trim()
              }
              variant={
